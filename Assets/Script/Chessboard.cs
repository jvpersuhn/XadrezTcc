...
public class Chessboard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(ray, out info, 100, LayerMask.GetMask("Tile", "Hover", "Highlight")))
        {
            ...
            if (currentlyDragging != null && Input.GetMouseButtonUp(0))
            {
                ...
                {
                    MoveTo(previusPosition.x, previusPosition.y, hitPosition.x, hitPosition.y);

                    NetMakeMove mm = new NetMakeMove();
                    mm.originalX = previusPosition.x;
                    mm.originalY = previusPosition.y;
    ...
    public void OnRematchButton()
    {
        ...
        else
        {
            ...
            rm.teamId = currentTeam;
            rm.wantRematch = 1;
            Debug.Log("Rematch multiplayer" + rm.wantRematch);
            Client.Instance.SendToServer(rm);
        }
    }
    ...
    private void SimulateMoveForSinglePiece(ChessPiece cp, ref List<Vector2Int> moves, ChessPiece targetKing)
    {
        ...
        for (int i = 0; i < moves.Count; i++)
        {
            ...
            Vector2Int kingPositiomThisSim = new Vector2Int(targetKing.currentX, targetKing.currentY);

            if (cp.type == ChessPieceType.King)
                kingPositiomThisSim = new Vector2Int(simX, simY);
            ...
            if (ContainsValidMove(ref simMoves, kingPositiomThisSim))
            {
    ...
    private void OnRematchClient(NetMessage message)
    {
        ...
        {
            rematchIndicator.transform.GetChild((rm.wantRematch == 1) ? 1 : 0).gameObject.SetActive(true);
            if (rm.wantRematch != 1)
            {
